...
function(a, b) {
    ...
    g.initHtml4 = function() {
        ...
        g.emulated.hashChange && (g.hashChangeInit = function() {
            ...
            var b = "", d, e, h, i;
            return g.isInternetExplorer() ? (d = "historyjs-iframe",
            ...
            g.checkerFunction = function() {
                ...
                g.Adapter.trigger(a, "hashchange")) : d !== h && (h = d,
                g.setHash(d, !1)),
                i = !1,
                !0
            }
        ...
        g.emulated.pushState && (g.onHashChange = function(b) {
            ...
            g.busy(!1),
            !1) : (f = g.extractState(g.getFullUrl(e || c.location.href, !1), !0),
            g.isLastSavedState(f) ? (g.busy(!1),
            !1) : (h = g.getHashByState(f),
            j = g.discardedState(f),
            j ? (g.getHashByIndex(-2) === g.getHashByState(j.forwardState) ? g.back(!1) : g.forward(!1),
            !1) : (g.pushState(f.data, f.title, f.url, !1),
            !0))))
        }
        ,
        ...
        g.pushState = function(b, d, e, f) {
            ...
            g.setTitle(h),
            i === k ? (g.busy(!1),
            !1) : i !== l && i !== g.getShortUrl(c.location.href) ? (g.setHash(i, !1),
            !1) : (g.saveState(h),
...
function(a, b) {
    ...
    m.init = function() {
        return typeof m.Adapter == "undefined" ? !1 : (typeof m.initCore != "undefined" && m.initCore(),
    ...
    m.initCore = function() {
        ...
        m.extractState = function(a, b) {
            ...
            d = m.getIdByUrl(e) || !1,
            d && (c = m.getStateById(d)),
            !c && b && !m.isTraditionalAnchor(a) && (c = m.createStateObject(null, null, e))),
            c
        }
        ,
        ...
        m.isLastSavedState = function(a) {
            var b = !1, c, d, e;
            return m.savedStates.length && (c = a.id,
        ...
        if (m.emulated.pushState) {
            ...
            m.onPopState = function(b, c) {
                ...
                g = m.getHash(),
                g ? (h = m.extractState(g || d.location.href, !0),
                h ? m.replaceState(h.data, h.title, h.url, !1) : (m.Adapter.trigger(a, "anchorchange"),
                m.busy(!1)),
                m.expectedStateId = !1,
                !1) : (e = m.Adapter.extractEventData("state", b, c) || !1,
                e ? f = m.getStateById(e) : m.expectedStateId ? f = m.getStateById(m.expectedStateId) : f = m.extractState(d.location.href),
                f || (f = m.createStateObject(null, null, d.location.href)),
                m.expectedStateId = !1,
                m.isLastSavedState(f) ? (m.busy(!1),
                !1) : (m.storeState(f),
                m.saveState(f),
                m.setTitle(f),
